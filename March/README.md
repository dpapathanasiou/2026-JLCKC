# [February](../February/README.md) 28, 1 [矢庭に](<./2026 FEBRUARY 28 - 2026 MARCH 1.pdf>)
...
- 上品で慎み深く、心かひかれる。
    > It is something elegant and modest, and also very appealing.
- 「ゆかし」は「行かし」で、心かひかれて見たい、知りたいなどと思うさま。
    > "Yukashi" means "to go," and it means being attracted to something and wanting to see it or learn more about it.
- 「奥床しい」は、その奥にあるものに心でかれるが原義。
    > The original meaning of "elegant" is to be captivated by what lies deep within.
- 「 床」は、当て字。
    > "Yoko (床)" is a phonetic spelling.

# 5, 6 [いろは](<./2026 MARCH 5-6.pdf>)
...
- 「将棋のいろはも知らない」などと使う。
    > It is used in expressions such as "I don't know the basics of shogi."
- もとは、「いろは歌」の最初の三文字のことで、かな四七字の総称。
    > Originally, it referred to the first three characters of the Iroha song, and is a general term for the 47 kana characters.
- 習字の最初にこの「いろは」を習うことから、初歩・習いはじめを意味するようになった。
